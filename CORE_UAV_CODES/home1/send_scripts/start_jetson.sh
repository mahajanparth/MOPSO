...
sysid=$(($ip -100))
#wait
gnome-terminal -- mavproxy.py --master=/dev/ttyTHS1 --out=127.0.0.1:14550 --out=127.0.0.1:14551 --out=127.0.0.1:14552 --out=127.0.0.1:14553 --out=127.0.0.1:14554 
...
sudo ip addr add 192.168.1.$ip2/24 dev $interface
